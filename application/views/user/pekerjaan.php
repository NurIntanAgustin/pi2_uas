...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Nur Intan Agustin</span>
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="<?= base_url('assets/user/img/profile1.png') ?>" </span>
        </a>
    ...
    <div class="container-fluid p-0">
        <!-- Education-->
        <section class="resume-section" id="pekerjaan">
            <div class="resume-section-content">
                <h3 class="mb-5">Pengalaman Kerja</h3>
                <?php foreach ($pekerjaan_list as $list) : ?>
                    <div class="d-flex" data-id="<?= $list['pekerjaan_id'] ?>">
                        <div class="d-flex flex column flex-md-row justify-content-between-mb-4">
                            <div class="flex-grow-1">
                                <h4 class="mb-0"><?= $list['nama_perusahaan'] ?></h4>
                                <div class="subheading mb-3"><?= $list['role'] ?> - (<?= $list['tahun'] ?>)
                                </div>
                            </div>
                        </div>
                    </div>
