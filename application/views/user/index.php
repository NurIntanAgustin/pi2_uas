...
<head>
    ...
    <title>Resume</title>
    <link rel="icon" type="image/x-icon" href="assets/user/img/favicon.icon" />
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                <h2 class="mb-0">
                    <span class="text-primary">Nur Intan Agustin</span>
                </h2>

                <p class="lead mb-5">I am experienced in UI/UX Design for web and apllication. Interest in social media content and design.</p>
