    ...
    <section class="resume-section" id="education">
        <div class="resume-section-content">
            ...
            <?php foreach ($profile_list as $list) : ?>
                <div class="d-flex" data-id="<?= $list['profile_id'] ?>">
                    <div class="d-flex flex column flex-md-row justify-content-between-mb-4">
                        <div class="flex-grow-1">
                            <h4 class="mb-0">Nama</h4>
                            <div class="subheading mb-3"><?= $list['nama'] ?> </div>
                            <h4 class="mb-0">Tanggal Lahir</h4>
                            <div class="subheading mb-3"><?= $list['tgl_lahir'] ?> </div>
                            <h4 class="mb-0">Jenis Kelamin</h4>
                            <div class="subheading mb-3"><?= $list['jenis_kelamin'] ?> </div>
                            <h4 class="mb-0">Kewarganegaraan</h4>
                            <div class="subheading mb-3"><?= $list['kewarganegaraan'] ?> </div>
